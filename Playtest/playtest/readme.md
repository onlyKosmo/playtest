Nom : FERRAND-RICHARTE
Prenom : Basile



Description des fonctionnalités implémenté :
reset.php location : admin/reset.php



Présentation de Playtest
Playtest est une plateforme en ligne permettant aux utilisateurs de découvrir, noter et commenter des jeux vidéo. Les utilisateurs peuvent s'inscrire, se connecter, et interagir avec une base de données de jeux classés par leurs utilisateurs à travers des notes et des critiques. Le site propose une interface simple et efficace pour consulter des jeux, soumettre des avis et explorer de nouveaux titres.
